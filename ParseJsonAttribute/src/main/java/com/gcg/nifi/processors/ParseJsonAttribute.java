...
public class ParseJsonAttribute extends AbstractProcessor {
    ...
    public void onTrigger(ProcessContext context, ProcessSession session)
        ...
        String attribute = flowfile.getAttribute(context.getProperty(JSON_ATTRIBUTE).getValue());
        String properties = context.getProperty(JSON_PROPERTIES).getValue();
